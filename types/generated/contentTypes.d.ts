...
export interface ApiAirportAirport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Airport_Status: Schema.Attribute.Enumeration<['Active', 'Inactive']> &
      Schema.Attribute.Required &
...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dropoffHotel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    dropoffHouse: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    dropoffNearby: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::booking.booking'
    >;
    passengers: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    pickupAddress: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'pickupAddress'>;
    ...
    pickupHotel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    pickupHouse: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    pickupNearby: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cityStatus: Schema.Attribute.Enumeration<['active', 'inactive']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'active'>;
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Destination_Status: Schema.Attribute.Enumeration<['Active', 'Inactive']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiDiscountDiscount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amount_in_percentage: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    for_all_routes: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
...
export interface ApiFeatureFeature extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Feature_Status: Schema.Attribute.Enumeration<['Active', 'Inactive']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiRouteRoute extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    distance_km: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.DefaultTo<1>;
    dropoff: Schema.Attribute.DynamicZone<
      ['route.destination', 'route.location']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    pickup: Schema.Attribute.DynamicZone<
      ['route.location', 'route.destination']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiVehicleTypeVehicleType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::vehicle-type.vehicle-type'
    >;
    Nr_Of_Big_Lagguage: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Schema.Attribute.DefaultTo<1>;
    Nr_Of_Ski_Equipment: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    Vehicle_type_status: Schema.Attribute.Enumeration<['Active', 'Inactive']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
